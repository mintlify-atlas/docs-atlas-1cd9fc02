...
<Steps>
  <Step title="Clone and install">
    ...
    <Tip>
      Running inside Docker is strongly recommended because the agent uses `shell_exec` and `python_exec` — high-privilege tools that can affect your host system. See the [installation guide](/installation#docker-setup) for a container-based setup.
    </Tip>
  </Step>
